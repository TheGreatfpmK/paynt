...
@pytest.fixture
def smpmc_tiny_task():
    """The SynthesisTask sibling of smpmc_tiny_colored_mdp_factory -- loaded independently (see
    tests/pomdp/conftest.py's equivalent fixtures) so each fixture has its own SynthesisTask, not one
