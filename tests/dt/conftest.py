...
def dt_colored_mdp_factory():
    """The same sketch get_dt_with_api.py (a real script exercising paynt.dt's library API) uses -- confirmed to resolve through DtColoredMdpFactory via the
    normal Sketch.load_sketch path too.
