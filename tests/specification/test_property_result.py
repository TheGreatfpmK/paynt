...
class TestUndecidedResults:
    ...
    undecided_result() (paper Section https://www.jair.org/index.php/jair/article/view/16593 3.3, "AR for
    Feasibility Synthesis with Multiple Constraints"): returns every still-relevant property result
    (undecided constraints ascending, then optimality if it can still
